# Module 3 - App Service: An Approximate Step-by-Step Guide
...
- Method 1: Using Azure CLI
   ...
   <img src="images/module-03-app-service/st-01-01.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- In the Azure portal, click on "Create a resource" and search for "Resource group."
  ...
  <img src="images/module-03-app-service/st-01-02-01.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Choose a name for the resource group, select your subscription (the billing unit for Azure services), and choose a region (the physical location of the resource group).
  ...
  <img src="images/module-03-app-service/st-01-02-02.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>

- Click "Review + create" and then "Create."

  <img src="images/module-03-app-service/st-01-02-03.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Select the "Basic" SKU. Azure offers different service tiers with varying features and pricing. For beginners, the Basic tier provides a good starting point.
  ...
  <img src="images/module-03-app-service/st-01-03-01.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>

- Click "Review + create" and then "Create." The ACR will serve as a central repository for your Docker images.

  <img src="images/module-03-app-service/st-01-03-02.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- In this example:
   ...
   <img src="images/module-03-app-service/st-02-01-01.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Example:
  ...
  <img src="images/module-03-app-service/st-02-01-02.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Example (from the `petstore/` directory):
  ...
  <img src="images/module-03-app-service/st-02-01-03.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
  
- Check your Azure Container Registry (ACR).

  <img src="images/module-03-app-service/st-02-01-04.png" width="500" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Click on 'Review + create', and then click 'Create' to finalize.
  ...
  <img src="images/module-03-app-service/st-03-01-01.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>
  <br>
  <img src="images/module-03-app-service/st-03-01-02.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Move to the "Docker" tab and set up these settings:
  ...
  <img src="images/module-03-app-service/st-03-02-01.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Locate the default domain link on your application page. This link usually follows the format: `https://yourwebappname.azurewebsites.net`. Click on it to open your web app in a browser.
  ...
  <img src="images/module-03-app-service/st-03-02-02.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
  <br>
  <img src="images/module-03-app-service/st-03-02-03.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Follow the same deployment steps for each Public API Services (PetService, ProductService, OrderService), selecting the common App Service Plan.
  ...
  <img src="images/module-03-app-service/st-03-03-01.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Add environment variables to configure URLs between services. These variables are essential for services to communicate with each other.
  ...
  <img src="images/module-03-app-service/st-03-04-01.png" width="700" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- For example, `PETSTOREPETSERVICE_URL` should point to the URL of the PetService. The required environment variables can be found in the `application.yml` file of each service and in the `docker-compose.yml` file used for local development.
  ...
  <img src="images/module-03-app-service/st-03-04-02.png" width="700" style="padding-top: 20px; padding-bottom: 20px;"/>

- If you've followed all the steps correctly, you should be able to navigate between pages without any errors.

  <img src="images/module-03-app-service/st-03-04-03.gif" width="700" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Select "Rules Based" scale out method and click "Manage rules based scaling."
  ...
  <img src="images/module-03-app-service/st-04-01-01.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Click "Add a rule."
  ...
  <img src="images/module-03-app-service/st-04-01-02.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Similarly, you can create a rule to decrease the instance count if CPU usage is less than 25% for 5 minutes.
  ...
  <img src="images/module-03-app-service/st-04-01-03.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- To test autoscaling, refer to the guide on testing with the k6 toolk: [Test autoscaling using k6 tool](using-k6.md).
- Utilize Swagger to identify endpoints for testing. For example, employ the `/petstorepetservice/v2/pet/info` endpoint to evaluate PetService autoscaling.
  ...
  <img src="images/module-03-app-service/st-04-02-01.png" width="500" style="padding-top: 20px; padding-bottom: 20px;"/>
  <br>
  <img src="images/module-03-app-service/st-04-02-02.png" width="500" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Create a deployment slot:
  ...
  <img src="images/module-03-app-service/st-05-01-01.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Configure slot settings:
  ...
  - This configuration step ensures that the Docker image used in your Azure Container Registry (ACR) will be utilized by the slot.
    ...
    <img src="images/module-03-app-service/st-05-01-02.png" width="500" style="padding-top: 20px; padding-bottom: 20px;"/>
    <br>
    <img src="images/module-03-app-service/st-05-01-03.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Enable continuous deployment:
  ...
  <img src="images/module-03-app-service/st-05-01-04.png" width="500" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Access the URL of the deployment slot to evaluate the modifications you have implemented.
  ...
  <img src="images/module-03-app-service/st-05-03-01.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Look for the "Swap" button. Click on it to initiate the slot swap process.
  ...
  <img src="images/module-03-app-service/st-05-03-02.png" width="500" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Indicate your subscription and resource group.
  ...
  <img src="images/module-03-app-service/st-06-01.png" width="600" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Perform the same sequence of actions for the PetStoreApp instance in the second region, while assigning a priority of "2".
  ...
  <img src="images/module-03-app-service/st-06-02-01.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
  <br>
  <img src="images/module-03-app-service/st-06-02-02.png" width="800" style="padding-top: 20px; padding-bottom: 20px;"/>
...
- Test main features to ensure the application works as expected.
  ...
  <img src="images/module-03-app-service/st-06-03-01.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>
  <br>
  <img src="images/module-03-app-service/st-06-03-02.png" width="900" style="padding-top: 20px; padding-bottom: 20px;"/>

<hr>

<div style="border: 2px solid red; padding: 10px; text-align: center;">
<span style="color: red;"><strong>Resources left running can cost you money. You can delete resources individually or delete the resource group to delete the entire set of resources.</strong></span>
</div>
